...
[tnList2,ynList2] = ExplicitTrapezoid(@func,tspan,N,y0);
...
lw = 2;
semilogy(tnList,abs(y-ynList),'LineWidth',1)
hold on
    title('\textbf{Global error over time for} $\dot{x}(t) = -x(t)$',...
        'interpreter','latex');
    semilogy(tnList1,abs(y-ynList1),'LineWidth',1)
...
[tnList2,ynList2] = ExplicitTrapezoid(@IVP2,tspan,N,Y0);
...
for i = 1:len
    ...
    [tnList2,ynList2] = ExplicitTrapezoid(@IVP2,tspan,NList(i),Y0);
...
for i = 1:len
    ...
    [tnList2,ynList2] = ExplicitTrapezoid(@func,tspan,NList(i),y0);
...
%     [tnList3,ynList3] = ExplicitTrapezoid(@func,tspan,NList(i),y0);
%     [tnList33,ynList33] = ExplicitTrapezoid(@func,tspan,2*NList(i),y0);
...
for i = 1:len
    ...
    [tnList3,ynList3] = ExplicitTrapezoid(@IVP2,tspan,NList(i),Y0);
    [tnList33,ynList33] = ExplicitTrapezoid(@IVP2,tspan,2*NList(i),Y0);
